...
export class TransformInterceptor<T> implements NestInterceptor<T, Response<T>> {
  intercept(context: ExecutionContext, next: CallHandler): Observable<any> {
    ...
    req.body = camelCaseToSnakeCase(req.body);
    req.params = camelCaseToSnakeCase(req.params);
    req.query = camelCaseToSnakeCase(req.query);
    req.query = setDefaulSort(req.query);
